...
<head>
    <title>Abhyaz - Online HR Portal</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../index.html">
            <img class="logo-one" src="../assets/logo and favicon/logo.png" alt="Navbar logo" />
        </a>
    ...
    <footer id="contact">
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <a href="../index.html">
                            <img class="logo2" src="../assets/logo and favicon/logo.png" alt="footer logo" />
                        </a>
                        <p class="content1">
                            Abhyaz.in (a unit of Smilyo Private Limited) started as an ERP
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="social-icons">
                            <a class="icon-link" href="https://www.facebook.com/Abhyazdotin/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a class="icon-link" href="https://www.instagram.com/Abhyazin/"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                            <a class="icon-link" href="https://twitter.com/Abhyazin"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a class="icon-link" href="https://www.linkedin.com/company/gst-n-it/"><i class="fa fa-linkedin" aria-hidden="true"></i></a>

                            <br /><br />
                            <p class="contact-details">
                                <i class="fa fa-envelope" aria-hidden="true"></i> &nbsp;
                                Abhyazin@gmail.com <br /><br />
            ...
            <div class="footer2">
                Abhyaz.in&nbsp;&copy;&nbsp;2020 All Rights Reserved.
            </div>
        </div>
    </footer>
